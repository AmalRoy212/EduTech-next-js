  ...
  return (
    <div className="mb-3 flex items-center">
      <span className="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-primary bg-opacity-10 text-primary">
       ...
       {status === "active" ? <p className="m-0 text-base font-medium text-body-color text-green-500">{text}</p> : <p className="m-0 text-base font-medium text-body-color text-red-500">{text}</p>}
