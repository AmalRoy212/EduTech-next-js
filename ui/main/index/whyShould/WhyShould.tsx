    ...
    const data = [
        {
          ...
          content: [
            "Draft new regulations, meet potential partners, network with global Education Technology experts.",
            "Learn from industry experts and thought leaders to help draft new regulations and policies.",
            "Explore the latest EdTech innovations from established tech leaders and emerging startups.",
            "Explore collaboration opportunities with top global technology enterprises.",
            "Network with elite EdTech experts, business owners, investors, and startups.Identify and incentivize local startups with the potential to develop innovative solutions and services.",
          ]
        },
        {
          heading: 'WHY SHOULD EDUCATIONAL INSTITUTIONS ATTEND?',
          content: [
            "Interact directly with customers seeking suitable product solutions.",
        ...
        },
        {
          ...
          content: [
            ...
            "Showcase your innovations in front of early adopters who are eager to explore EdTech solutions in their institutions.",
            "Showcase Your Products & Services to several educators, researchers, and eager investors attending the event.",
            "Raise funds by meeting with potential investors interested in your type of product and solutions.Present your ideas and innovations in front of a curated audience consisting of investors, senior government authorities, and global education technology enterprises.",
            "Get maximum brand exposure through regional and international media, tech-bloggers, and journalists.Learn and network with international EdTech experts and regional policymakers.",
          ]
        },
        {
          heading: 'WHY SHOULD INVESTORS ATTEND?',
          content: [
            "Meet curated startup, network with elites from enterprises, governments and global EdTech experts",
