      ...
      <div className="container md:px-0 px-4">
        <div className="flex justify-center">
          <div className="md:flex hidden md:mt-[-3rem] lg:w-5/12 lg:order-2 lg:order-first">
            <div className="document-img text-center wow fadeInUp" data-wow-delay=".2s">
              <img src='/images/PNGs/startUp.png' className="w-[400px]" alt="" />
            </div>
          </div>

          <div className="lg:w-5/12 md:w-7/12">
            <div className="document-content mt-8 lg:mt-0 wow fadeInRight" data-wow-delay=".2s">
              <div className="mb-8">
                <span className="text-sm text-gray-200">Startup Pitch</span>
                <h2 className="text-3xl font-bold">
                  Startup Pitch <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">Competition - Elevating</span> Startup To Success
                </h2>
              </div>

              <ul className="document-list">
                <li className="mb-4 text-slate-300">Stand a chance to win Genfinity credit valued at up to $9999</li>
                <li className="text-gray-100">Startup Pitch Competition serves as a premier fundraising platform, catering to companies in various stages of development. Whether you are in the initial stages of launching your business or an established entity aiming for expansion, this platform offers an exclusive opportunity. Here, you can present your business propositions before a distinguished audience, comprising global investors such as venture capitalists, angel investors, and influential government authorities.</li>
              </ul>
