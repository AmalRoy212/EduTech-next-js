...
function MobileNav({ setPopup } : any) {
    return (
        <div className='w-full left-0 fixed h-screen backdrop-blur md:hidden flex justify-center items-center pb-[5rem]  px-3 z-[999]'>
            <div className='w-full h-full bg-slate-800 flex flex-col px-10 rounded-2xl py-5'>
                <a onClick={() => setPopup(false)} href="#about-us" className='cursor-pointer text-[18px] text-center py-2  w-auto mx-15 my-2 rounded-lg text-white bg-gradient-to-r from-purple-500 to-cyan-500'>About us</a>
                <a onClick={() => setPopup(false)} href="#happening" className='cursor-pointer text-[18px] text-center py-2  w-auto mx-15 my-2 rounded-lg text-white bg-gradient-to-r from-purple-500 to-cyan-500'>Happening</a>
                <a onClick={() => setPopup(false)} href="#attendies" className='cursor-pointer text-[18px] text-center py-2  w-auto mx-15 my-2 rounded-lg text-white bg-gradient-to-r from-purple-500 to-cyan-500'>Attendies</a>
                <a onClick={() => setPopup(false)} href="#topics" className='cursor-pointer text-[18px] text-center py-2  w-auto mx-15 my-2 rounded-lg text-white bg-gradient-to-r from-purple-500 to-cyan-500'>Topics</a>
