...
function Counter() {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      ...
      const eventDate = new Date("2024-05-05").getTime(); // event date timestamp in milliseconds
  ...
  return (
    <div
      ...
      className="w-full h-auto flex absolute justify-center items-center z-20 md:top-0 md:mt-[4rem] mt-[49rem]"
    >
